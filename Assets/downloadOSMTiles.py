#!/usr/bin/env python
# Generated by BigMap 2. Permalink: http://bigmap.osmz.ru/bigmap.php?xmin=4456&xmax=4479&ymin=2832&ymax=2855&zoom=13&scale=256&tiles=mapnik
...
(zoom, xmin, ymin, xmax, ymax) = (13, 4456, 2832, 4479, 2855)
...
for x in range(xmin, xmax+1):
  for y in range(ymin, ymax+1):
    for layer in layers:
      ...
      directory = "./zooom-%02d/x-%02d/" % (zoom, x)
      if not os.path.exists(directory):
        os.makedirs(directory)
                        
      outputFileName = "./zooom-%02d/x-%02d/map-y-%02d.png" % (zoom, x,y)
